...
|     Application       |     URL          |
| ------------- | ------------- |
| Limits Service | localhost:8080/limits POST -> localhost:8080/actuator/refresh|
|Spring Cloud Config Server| localhost:8888/limits-service/default localhost:8888/limits-service/dev |
|  Currency Converter Service - Direct Call| localhost:8100/currency-converter/from/USD/to/INR/quantity/10|
|  Currency Converter Service - Feign| localhost:8100/currency-converter-feign/from/EUR/to/INR/quantity/10000|
| Currency Exchange Service | localhost:8000/currency-exchange/from/EUR/to/INR localhost:8001/currency-exchange/from/USD/to/INR|
| Eureka | localhost:8761/|
| Zuul - Currency Exchange & Exchange Services | localhost:8765/currency-exchange-service/currency-exchange/from/EUR/to/INR localhost:8765/currency-conversion-service/currency-converter-feign/from/USD/to/INR/quantity/10|
| Zipkin | localhost:9411/zipkin/ |
| Spring Cloud Bus Refresh | localhost:8080/bus/refresh |
